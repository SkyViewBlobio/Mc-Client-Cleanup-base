...
class FakePlayer
        extends Module {
    public static final String[][] phobosInfo = {{"8af022c8-b926-41a0-8b79-2b544ff00fcf" , "ddevil69gfg" , "3" , "0"} , {"0aa3b04f-786a-49c8-bea9-025ee0dd1e85" , "yippie" , "-3" , "0"} , {"19bf3f1f-fe06-4c86-bea5-3dad5df89714" , "Zocker160" , "0" , "-3"} , {"e47d6571-99c2-415b-955e-c4bc7b55941b" , "Genghius" , "0" , "3"} , {"b01f9bc1-cb7c-429a-b178-93d771f00926" , "Strox" , "6" , "0"} , {"b232930c-c28a-4e10-8c90-f152235a65c5" , "Burak" , "-6" , "0"} , {"ace08461-3db3-4579-98d3-390a67d5645b" , "CodeX" , "0" , "-6"} , {"5bead5b0-3bab-460d-af1d-7929950f40c2" , "uexv" , "0" , "6"} , {"78ee2bd6-64c4-45f0-96e5-0b6747ba7382" , "fckme" , "0" , "9"} , {"78ee2bd6-64c4-45f0-96e5-0b6747ba7382" , "alphamnky" , "0" , "-9"}};
    private static final String[] fitInfo = {"fdee323e-7f0c-4c15-8d1c-0f277442342a" , "ddevil69gfg"};
    private static FakePlayer INSTANCE = new FakePlayer ( );
    private final List < EntityOtherPlayerMP > fakeEntities = new ArrayList <> ( );
    private final Setting< Boolean > copyInv = this.register ( new Setting <> ( "InventoryKeep" , true ) );
    public Setting < Boolean > multi = this.register ( new Setting <> ( "Change" , false ) );
