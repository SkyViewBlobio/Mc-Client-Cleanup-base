...
public class ReloadSoundCommand extends Command {
    ...
    public void execute(final String[] commands) {
        try {
            ...
            System.out.println(ChatFormatting.LIGHT_PURPLE + "Could not restart sound manager: " + e.toString());
            e.printStackTrace();
            Command.sendMessage(ChatFormatting.LIGHT_PURPLE + "Couldnt Reload Sound System!");
        }
    }
}
