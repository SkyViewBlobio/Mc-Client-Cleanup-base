...
public class AutoCrystal extends Module {
    ...
    public final me.alpha432.oyvey.util.Timer threadTimer = new me.alpha432.oyvey.util.Timer();
    ...
    private final me.alpha432.oyvey.util.Timer switchTimer = new me.alpha432.oyvey.util.Timer();
    ...
    private final me.alpha432.oyvey.util.Timer syncTimer = new me.alpha432.oyvey.util.Timer();
    private final me.alpha432.oyvey.util.Timer predictTimer = new me.alpha432.oyvey.util.Timer();
    private final me.alpha432.oyvey.util.Timer renderTimer = new me.alpha432.oyvey.util.Timer();
    private final AtomicBoolean shouldInterrupt = new AtomicBoolean(false);
    private final me.alpha432.oyvey.util.Timer syncroTimer = new me.alpha432.oyvey.util.Timer();
    private final Map<EntityPlayer, me.alpha432.oyvey.util.Timer> totemPops = new ConcurrentHashMap<EntityPlayer, me.alpha432.oyvey.util.Timer>();
    ...
    public Setting<Raytrace> raytrace = this.register(new Setting<Object>("Raytrace", Raytrace.NONE, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<Switch> switchMode = this.register(new Setting<Object>("Attacks", Switch.BREAKSLOT, v -> this.setting.getValue() == Settings.Attacks && this.explode.getValue() != false));
    ...
    public Setting<PredictTimer> instantTimer = this.register(new Setting<Object>("PDTTime", PredictTimer.NONE, v -> this.setting.getValue() == Settings.Attacks && this.explode.getValue() != false && this.place.getValue() != false && this.instant.getValue() != false));
    ...
    public Setting<Boolean> sequential = this.register(new Setting<Object>("sequential", true, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<Target> targetMode = this.register(new Setting<Object>("target", Target.CLOSEST, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<AutoSwitch> autoSwitch = this.register(new Setting<Object>("Switch", AutoSwitch.TOGGLE, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<Boolean> switchBack = this.register(new Setting<Object>("Switchback", Boolean.valueOf(true), v -> this.setting.getValue() == Settings.Miscs && this.autoSwitch.getValue() != AutoSwitch.NONE && this.offhandSwitch.getValue ( ) && this.autoSwitch.getValue ( ) != AutoSwitch.SILENT ));
    ...
    public Setting<Rotate> rotate = this.register(new Setting<Object>("rotate", Rotate.OFF, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<AntiFriendPop> antiFriendPop = this.register(new Setting<Object>("Friendpop", AntiFriendPop.NONE, v -> this.setting.getValue() == Settings.Miscs));
    ...
    public Setting<Logic> logic = this.register(new Setting<Object>("Cognition", Logic.BREAKPLACE, v -> this.setting.getValue() == Settings.Overall));
    public Setting<DamageSync> damageSync = this.register(new Setting<Object>("DMGsync", DamageSync.NONE, v -> this.setting.getValue() == Settings.Overall));
    ...
    public Setting<ThreadMode> threadMode = this.register(new Setting<Object>("Threadded", ThreadMode.NONE, v -> this.setting.getValue() == Settings.Overall));
    ...
    public AutoCrystal() {
        super("CrystalAuraSilent (X)", "Will Make You Cum Sideways", Category.COMBAT, true, false, false);
        instance = this;
    }
    ...
    public void onPacketReceive(PacketEvent.Receive event) {
        ...
        if (!this.justRender.getValue().booleanValue() && this.switchTimer.passedMs(this.switchCooldown.getValue().intValue()) && this.explode.getValue().booleanValue() && this.instant.getValue().booleanValue() && event.getPacket() instanceof SPacketSpawnObject && (this.syncedCrystalPos == null || !this.syncedFeetPlace.getValue().booleanValue() || this.damageSync.getValue() == DamageSync.NONE)) {
            ...
            if (packet5.getOpCode() == 35 && packet5.getEntity(AutoCrystal.mc.world) instanceof EntityPlayer) {
                this.totemPops.put((EntityPlayer) packet5.getEntity(AutoCrystal.mc.world), new me.alpha432.oyvey.util.Timer().reset());
            }
                    ...
                    if (syncflag || this.currentDamage - (double) damageOffset > this.lastDamage || this.syncTimer.passedMs(this.damageSyncTime.getValue().intValue()) || this.damageSync.getValue() == DamageSync.NONE) {
                        ...
                        if (this.switchItem()) {
                            ...
                            if (this.foundDoublePop) {
                                this.totemPops.put(target, new me.alpha432.oyvey.util.Timer().reset());
                            }
    ...
    public static class PlaceInfo {
        ...
        public void runPlace() {
            ...
            BlockUtill.placeCrystalOnBlock(this.pos, this.offhand ? EnumHand.OFF_HAND : EnumHand.MAIN_HAND, this.placeSwing, this.exactHand, silent);
