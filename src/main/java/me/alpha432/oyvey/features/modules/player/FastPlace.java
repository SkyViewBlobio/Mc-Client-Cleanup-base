...
class FastPlace
        extends Module {
    private final Setting< Boolean > all = this.register ( new Setting <> ( "EverythingForced" , false ) );
    private final Setting < Boolean > obby = this.register ( new Setting < Object > ( "OBy" , Boolean.FALSE , v -> ! this.all.getValue ( ) ) );
    private final Setting < Boolean > enderChests = this.register ( new Setting < Object > ( "Ec" , Boolean.FALSE , v -> ! this.all.getValue ( ) ) );
    private final Setting < Boolean > crystals = this.register ( new Setting < Object > ( "Crystal Mode" , Boolean.FALSE , v -> ! this.all.getValue ( ) ) );
    private final Setting < Boolean > exp = this.register ( new Setting < Object > ( "Exp" , Boolean.FALSE , v -> ! this.all.getValue ( ) ) );
    private final Setting < Boolean > Minecart = this.register ( new Setting < Object > ( "CrystalForcedOnMax[Beta]" , Boolean.FALSE , v -> ! this.all.getValue ( ) ) );
