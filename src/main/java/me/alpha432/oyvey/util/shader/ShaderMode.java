...
public enum ShaderMode {
    ...
    //BLURIMAGE("BlurShader", ItemShader::getInstance)
    ...
    public FramebufferShader getShader() {
        return shaderProducer.getInstance();
    }
}