...
public class SeconddaryInventoryUtil
    ...
    public static void switchToHotbarSlot(int slot, boolean silent) {
        ...
        if (silent) {
            SeconddaryInventoryUtil.mc.player.connection.sendPacket(new CPacketHeldItemChange(slot));
    ...
    public static List<Integer> findEmptySlots(boolean withXCarry) {
        ...
        if (withXCarry) {
            for (int i = 1; i < 5; ++i) {
                Slot craftingSlot = SeconddaryInventoryUtil.mc.player.inventoryContainer.inventorySlots.get(i);
    ...
    private static Map<Integer, ItemStack> getInventorySlots(int currentI, int last) {
        ...
        for (int current = currentI; current <= last; ++current) {
            fullInventorySlots.put(current, SeconddaryInventoryUtil.mc.player.inventoryContainer.getInventory().get(current));
        }
    ...
    public static boolean isSlotEmpty(int i) {
        Slot slot = SeconddaryInventoryUtil.mc.player.inventoryContainer.inventorySlots.get(i);
    ...
    public static int findArmorSlot(EntityEquipmentSlot type, boolean binding, boolean withXCarry) {
        int slot = SeconddaryInventoryUtil.findArmorSlot(type, binding);
