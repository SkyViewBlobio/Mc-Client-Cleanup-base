...
public class EntityUtill
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtill.isDead(entity) || entity.equals(mc.player) || entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName()) || mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            output.put(healthSB.toString() + " " + (OyVey.friendManager.isFriend(player) ? "\u00a7b" : "\u00a7r") + player.getName() + " " + distanceSB.toString() + " " + "\u00a7f" + OyVey.totemPopManager.getTotemPopString(player) + OyVey.potionManager.getTextRadarPotion(player), (int) mc.player.getDistance(player));
