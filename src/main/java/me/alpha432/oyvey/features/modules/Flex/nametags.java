...
class nametags
    ...
    private final Setting < Mode > mode = this.register ( new Setting <> ( "Modes" , Mode.SMALL ) );
    ...
    private final Setting < Boolean > heldStackName = this.register ( new Setting <> ( "ItemName" , false ) );
    ...
    private final Setting < Boolean > scaleing = this.register ( new Setting <> ( "Scaling" , false ) );
    ...
    public
    nametags ( ) {
        super ( "-Nametags" , "Better Nametags" , Category.Flex , false , false , false );
        this.setInstance ( );
    }
