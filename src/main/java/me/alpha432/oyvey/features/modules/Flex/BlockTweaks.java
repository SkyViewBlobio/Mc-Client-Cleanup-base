...
public class BlockTweaks extends Module
{
    ...
    public BlockTweaks() {
        super("-BlockTweak",  "Some tweaks for blocks.",  Category.Flex,  true,  false,  false);
        ...
        this.noFriendAttack = (Setting<Boolean>)this.register(new Setting("BetterFriendProtect", false));
        this.noBlock = (Setting<Boolean>)this.register(new Setting("NoHitboxBlock", true));
        this.noGhost = (Setting<Boolean>)this.register(new Setting("GhostBlockFix", false));
        this.destroy = (Setting<Boolean>)this.register(new Setting("destruction", false,  v -> this.noGhost.getValue()));
