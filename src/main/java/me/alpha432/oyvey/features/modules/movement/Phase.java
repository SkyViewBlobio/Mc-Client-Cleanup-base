...
class Phase
    ...
    public Setting < PacketFlyMode > type = this.register ( new Setting < Object > ( "Types" , PacketFlyMode.SETBACK , v -> this.mode.getValue ( ) == Mode.PACKETFLY ) );
    ...
    public Setting < Integer > teleportConfirm = this.register ( new Setting < Object > ( "Confirmed" , 2 , 0 , 4 , v -> this.mode.getValue ( ) == Mode.PACKETFLY && this.type.getValue ( ) == PacketFlyMode.SETBACK ) );
    ...
    public Setting < Boolean > cliperino = this.register ( new Setting < Object > ( "NotThroughWalls" , Boolean.FALSE , v -> this.mode.getValue ( ) == Mode.PACKETFLY && this.type.getValue ( ) == PacketFlyMode.SETBACK && this.setOnMove.getValue ( ) ) );
