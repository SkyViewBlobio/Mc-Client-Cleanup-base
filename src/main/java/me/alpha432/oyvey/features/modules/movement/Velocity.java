...
class Velocity
    ...
    public Setting< Boolean > knockBack = this.register ( new Setting <> ( "KB" , true ) );
    public Setting < Boolean > noPush = this.register ( new Setting <> ( "NoPush" , true ) );
    public Setting < Float > horizontal = this.register ( new Setting <> ( "H-" , 0.0f , 0.0f , 100.0f ) );
    public Setting < Float > vertical = this.register ( new Setting <> ( "V-" , 0.0f , 0.0f , 100.0f ) );
